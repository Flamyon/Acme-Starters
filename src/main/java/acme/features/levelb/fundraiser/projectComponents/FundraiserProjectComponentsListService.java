...
@Service
public class FundraiserProjectComponentsListService extends AbstractService<Fundraiser, ProjectComponent> {
	...
	public void authorise() {
		...
		if (this.project == null)
			...
			memberships = this.repository.countProjectMemberByProjectIdAndRoleKindAndUserAccountId(this.project.getId(), userAccountId, MemberRole.FUNDRAISER);
