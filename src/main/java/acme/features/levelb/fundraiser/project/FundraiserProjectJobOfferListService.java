...
@Service
public class FundraiserProjectJobOfferListService extends AbstractService<Fundraiser, JobOffer> {
	...
	public void authorise() {
		...
		final boolean isMember = this.project != null && this.repository.countProjectMemberByProjectIdAndRoleKindAndUserAccountId(this.project.getId(), userAccountId, MemberRole.FUNDRAISER) > 0;
