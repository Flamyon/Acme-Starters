...
@Service
public class InventorProjectJobOfferListService extends AbstractService<Inventor, JobOffer> {
	...
	public void authorise() {
		...
		final boolean isMember = this.project != null && this.repository.countProjectMemberByProjectIdAndRoleKindAndUserAccountId(this.project.getId(), userAccountId, MemberRole.INVENTOR) > 0;
